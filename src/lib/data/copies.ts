...
export const getCopieByIds = impl.getCopieByIds;
export const contaCopieOffline = impl.contaCopieOffline;
export const contaCopieSenzaEtichetta = impl.contaCopieSenzaEtichetta;
